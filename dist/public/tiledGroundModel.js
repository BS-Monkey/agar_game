export class TiledGroundModel {
    ...
    _createMesh(scene) {
        // Create the Model
        var tiledGround = BABYLON.Mesh.CreateTiledGround("Tiled Ground", this.xmin, this.zmin, this.xmax, this.zmax, this.subdivisions, this.precision, scene);
    ...
    getMousePositionOnGround(scene) {
